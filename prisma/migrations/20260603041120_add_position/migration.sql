...
INSERT INTO "new_Category" ("created_at", "id", "name") SELECT "created_at", "id", "name" FROM "Category";
DROP TABLE "Category";
...
INSERT INTO "new_Novel" ("age_rating", "category_id", "characters", "created_at", "editor_model", "ending", "genre", "id", "notes", "num_chapters", "outline", "pov", "pov_character_id", "setting", "target_chars", "title", "tone", "updated_at", "writer_model") SELECT "age_rating", "category_id", "characters", "created_at", "editor_model", "ending", "genre", "id", "notes", "num_chapters", "outline", "pov", "pov_character_id", "setting", "target_chars", "title", "tone", "updated_at", "writer_model" FROM "Novel";
DROP TABLE "Novel";
