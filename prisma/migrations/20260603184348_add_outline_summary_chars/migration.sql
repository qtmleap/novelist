...
CREATE TABLE "new_Novel" (
    ...
    "outline_summary_chars" INTEGER NOT NULL DEFAULT 300,
...
INSERT INTO "new_Novel" ("age_rating", "category_id", "created_at", "editor_model", "ending", "genre", "id", "notes", "num_chapters", "outline", "position", "pov", "pov_character_id", "setting", "target_chars", "title", "tone", "updated_at", "writer_model") SELECT "age_rating", "category_id", "created_at", "editor_model", "ending", "genre", "id", "notes", "num_chapters", "outline", "position", "pov", "pov_character_id", "setting", "target_chars", "title", "tone", "updated_at", "writer_model" FROM "Novel";
DROP TABLE "Novel";
